    ...
    if arguments.fix:
        ...
        for filename in formatted_filenames:
            ...
            with open(filename, "rb") as reader:
                ...
                formatted = subprocess.check_output([arguments.clang_format_binary, filename])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exclude_globs", help="Filename containing globs for files that should be excluded from the checks"
    )
    parser.add_argument("--source_dirs", help="Comma-separated root directories of the code")
    parser.add_argument(
        "--fix",
        default=False,
        action="store_true",
